...
import { dictionaries, isRtl, resolveLocale } from "../i18n";
...
const DEFAULT_TITLE = dictionaries.ru.metaTitle;
const DEFAULT_DESCRIPTION = dictionaries.ru.metaDescription;

const FONTS_HREF =
  "https://fonts.googleapis.com/css2?family=Golos+Text:wght@400..900&family=JetBrains+Mono:wght@400;500;600&family=Vazirmatn:wght@100..900&display=swap";
...
function RootShell({ children }: { children: ReactNode }) {
  // The locale travels in ?lang= (see routes/index.tsx); the shell mirrors it
  // onto <html> so language and text direction are correct at SSR time.
